...
function simpleTest()
    ...
    if (clientID>-1)
        ...
        sim.simxSetJointPosition(clientID,joint_A1,60*pi/180,sim.simx_opmode_blocking);
        sim.simxSetJointPosition(clientID,joint_A2,70*pi/180,sim.simx_opmode_blocking);
        sim.simxSetJointPosition(clientID,joint_A3,0*pi/180,sim.simx_opmode_blocking);
